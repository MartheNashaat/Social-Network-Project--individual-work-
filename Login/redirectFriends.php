...
/* let the two boxes next to each other */
section {
  float: left;
  width: 250px;
  height: 300px; 
...
<div  style ="float: left; position: fixed; width: 250px; height: 300px;box-sizing: border-box; border: 10px solid #e3b6b3; padding: 20px;margin-top: 50px; margin-left: 9px; ">
   <ul>
    ...
    <a href="deleteFriend.php?value=1">
      <img src="images/Delete.png" width=50px; height="50px;" id="friends" alt= "friends"  style="position:fixed; margin-top :180px;margin-left: 110px; border:none; "></a>
       <label>
        <?php
        if ($pic=="")
        {
  ...
  <article >
    ...
    <!--About me label -->
    <p style="margin-top: -60px; margin-left:-25px;font-family:'Forte'; font-size: 140%;" > 
